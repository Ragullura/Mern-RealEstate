       ...
       <div className="container mx-auto px-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="flex items-center justify-center">
                   <FaHome className="text-8xl text-blue-500 hover:text-amber-200" />
               ...
               <div className="flex items-center justify-center">
                   <FaUserFriends className="text-8xl text-blue-500 hover:text-amber-200" />
                   <div className="ml-4 bg-teal-400 p-3 rounded-tr-3xl">
               ...
               <div className="flex items-center justify-center">
                   <FaHandshake className="text-8xl text-blue-500 hover:text-amber-200" />
                   <div className="ml-4 bg-teal-400 p-3 rounded-tr-3xl">
